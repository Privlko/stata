...
note that one of the key components of a *reference* is the ability to map - for our purposes this means limiting the data to non ambiguous genotypes only - therefore this script ommits genotypes with the allele code i.e. ID A C G T W and S - retaining RYMK only.

**remarks** 

**examples** - download the \*.vcf.gz files for chr1-22; chrX and chrMT from [ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/release/20130502/*](ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/release/20130502/*). this can be done manually of via wget, for example;
...
!bash -c "wget ${ftp}ALL.chrMT.phase3_callmom-v0_4.20130502.genotypes.vcf.gz"
