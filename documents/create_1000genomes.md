...
**examples** - download the \*.vcf.gz files for chr1-22 and chrX  from [ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/release/20130502/*](ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/release/20130502/*). this can be done manually of via wget, for example;
