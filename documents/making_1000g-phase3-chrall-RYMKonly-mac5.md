...
## create the eur-1000g-phase3-chrall-RYMKonly-mac5 plink binaries and reference datasets
...
**dependencies**
- download the \*.vcf.gz files for chr1-22; chrX and chrMT from [ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/release/20130502/*](ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/release/20130502/*). this can be done manually of via wget, for example;
```
