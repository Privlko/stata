...
| [```dir2dta```](https://github.com/ricanney/stata/blob/master/documents/dir2dta.md) | create a file listing all the folders within a directory
| [```fam2dta```](https://github.com/ricanney/stata/blob/master/documents/fam2dta.md) | imports plink \*.fam files into stata 
| [```files2dta```](https://github.com/ricanney/stata/blob/master/documents/fam2dta.md) | create a file listing all the files within a directory
...
| [```profilescore```](https://github.com/ricanney/stata/blob/master/documents/profilescore.md) | calculate polygenic risk scores over multiple thresholds for multiple genotype files against a single GWAS input.
| [```recodegenotype```](https://github.com/ricanney/stata/blob/master/documents/recodegenotype.md) | creates single letter IUPAC genotype code from the observed alleles
| [```recodestrand```](https://github.com/ricanney/stata/blob/master/documents/recodestrand.md) | ![](../images/under-construction.png)
| [```summary2gwas```](https://github.com/ricanney/stata/blob/master/documents/summary2gwas.md) | process association data for post-gwas analysis
