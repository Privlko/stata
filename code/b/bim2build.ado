...
qui { // module 1 - check input files
	noi di as text"# > "as input"bim2build "as text"................... checking build of (bim) "as result"`bim'.bim"
	noi checkfile, file(`bim'.bim)
	noi di as text"# > "as input"bim2build "as text".............. checking build against (ref) "as result"`ref'"
	noi checkfile, file(`ref')
	}
qui { // module 2 - measure overlap
	qui { // import bim file
		noi di as text"# > "as input"bim2build "as text".................................... import "as result"`bim'.bim"
		noi bim2dta, bim(`bim')
		erase `bim'_bim.dta
		keep snp chr bp
		}
	...
	qui { // report findings 
		noi di as text"# > "as input"bim2build "as text" ................ build overlap reported in " as result"`bim'.bim2build"
		...
		noi di as text"# > "as input"bim2build "as text" ................. build overlap plotted to " as result"`bim'.bim2build.png"
		keep in 1 
		...
		do _tmp.do
		noi di as text"# > "as input"bim2build "as text" .......... build identified as " as result"${bim2build}"as text" for "as result"`bim'.bim"
		erase _tmp.do
		}
	}
qui di as text"#########################################################################"
