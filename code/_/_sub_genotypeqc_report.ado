...
syntax  
	...
	_docx_paragraph_add_text(dh, "# =================================================================================")
	_docx_paragraph_add_linebreak(dh)
	_docx_paragraph_add_text(dh, "# This subset was created using the program -bim2build-.")  
	...
	_docx_paragraph_add_linebreak(dh)
	_docx_paragraph_add_text(dh, "# > Genome build of the input binaries : ${data_input}")
	_docx_paragraph_add_linebreak(dh)
	...
	_docx_paragraph_add_linebreak(dh)	 
	_docx_paragraph_add_text(dh, "([observed hom. count] - [expected count]) / ([total observations] - [expected count]) )"
	_docx_paragraph_add_linebreak(dh)	 
	...
	_docx_add_pagebreak(dh,)
	_docx_paragraph_set_textsize(dh, 20)
	_docx_paragraph_add_text(dh, "# Plotting hardy-weinbrg deviation")
	_docx_paragraph_add_linebreak(dh)
	...
	_docx_add_pagebreak(dh,)
	_docx_paragraph_set_textsize(dh, 20)
	_docx_paragraph_add_text(dh, "# Plottingminor allele frequency")
	_docx_paragraph_add_linebreak(dh)  
